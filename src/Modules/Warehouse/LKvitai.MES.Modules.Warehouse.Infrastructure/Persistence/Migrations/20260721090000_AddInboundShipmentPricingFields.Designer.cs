...
namespace LKvitai.MES.Modules.Warehouse.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260721090000_AddInboundShipmentPricingFields")]
    partial class AddInboundShipmentPricingFields
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("inbound_shipments", "public", t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_inbound_shipments_costs", "(\"FreightCost\" IS NULL OR \"FreightCost\" >= 0) AND (\"DutyCost\" IS NULL OR \"DutyCost\" >= 0) AND (\"InsuranceCost\" IS NULL OR \"InsuranceCost\" >= 0) AND (\"OtherCost\" IS NULL OR \"OtherCost\" >= 0)");
                        });
                });
