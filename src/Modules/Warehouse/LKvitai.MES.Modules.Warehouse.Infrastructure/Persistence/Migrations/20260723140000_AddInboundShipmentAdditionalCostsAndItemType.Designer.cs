...
namespace LKvitai.MES.Modules.Warehouse.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260723140000_AddInboundShipmentAdditionalCostsAndItemType")]
    partial class AddInboundShipmentAdditionalCostsAndItemType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LKvitai.MES.Modules.Warehouse.Domain.Entities.AuditLogArchive", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("LKvitai.MES.Modules.Warehouse.Domain.Entities.BackupExecution", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LKvitai.MES.Modules.Warehouse.Domain.Entities.DRDrill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LKvitai.MES.Modules.Warehouse.Domain.Entities.ErasureRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LKvitai.MES.Modules.Warehouse.Domain.Entities.EventArchive", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LKvitai.MES.Modules.Warehouse.Domain.Entities.InboundShipmentAdditionalCost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("inbound_shipment_additional_costs", "public", t =>
                        {
                            t.HasCheckConstraint("ck_inbound_shipment_additional_costs_amount", "\"Amount\" >= 0");
                        });
                });
            ...
            modelBuilder.Entity("LKvitai.MES.Modules.Warehouse.Domain.Entities.ItemPhoto", b =>
                {
                    ...
                    b.ToTable("item_photos", "public");
                });

            modelBuilder.Entity("LKvitai.MES.Modules.Warehouse.Domain.Entities.ItemPriceHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("item_price_history", "public", t =>
                        {
                            t.HasCheckConstraint("ck_item_price_history_type", "\"PriceType\" IN ('Base','Purchase','GroupOverride')");
                        });
                });

            modelBuilder.Entity("LKvitai.MES.Modules.Warehouse.Domain.Entities.ItemPriceOverride", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ItemId", "PriceGroupId")
                        .IsUnique();

                    b.ToTable("item_price_overrides", "public", t =>
                        {
                            t.HasCheckConstraint("ck_item_price_overrides_amount", "\"Amount\" >= 0");
                        });
                });
            ...
            modelBuilder.Entity("LKvitai.MES.Modules.Warehouse.Domain.Entities.Location", b =>
                {
                    ...
                    b.Property<string>("LocationRole")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");
                    ...
                    b.Property<string>("RackRowId")
                        .HasMaxLength(30)
                        .HasColumnType("character varying(30)");

                    b.Property<int?>("ShelfLevelIndex")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("RackRowId", "ShelfLevelIndex", "SlotStart")
                    ...
                    b.ToTable("locations", "public", t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_locations_rack_placement", "(\"RackRowId\" IS NULL AND \"ShelfLevelIndex\" IS NULL AND \"SlotStart\" IS NULL) OR (\"RackRowId\" IS NOT NULL AND \"ShelfLevelIndex\" IS NOT NULL AND \"SlotStart\" IS NOT NULL)");

                            t.HasCheckConstraint("ck_locations_role", "\"LocationRole\" IN ('Cell', 'Bulk', 'EndCap', 'Overflow', 'GroundSlot') OR \"LocationRole\" IS NULL");
            ...
            modelBuilder.Entity("LKvitai.MES.Modules.Warehouse.Domain.Entities.PiiEncryptionKeyRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LKvitai.MES.Modules.Warehouse.Domain.Entities.PriceGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("price_groups", "public");
                });

            modelBuilder.Entity("LKvitai.MES.Modules.Warehouse.Domain.Entities.RetentionExecution", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LKvitai.MES.Modules.Warehouse.Domain.Entities.RetentionPolicy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LKvitai.MES.Modules.Warehouse.Domain.Entities.Supplier", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("LastAgnumSyncedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("LKvitai.MES.Modules.Warehouse.Domain.Entities.Customer", b =>
                {
                    b.HasOne("LKvitai.MES.Modules.Warehouse.Domain.Entities.PriceGroup", "PriceGroup")
                        .WithMany("Customers")
            ...
            modelBuilder.Entity("LKvitai.MES.Modules.Warehouse.Domain.Entities.ItemPriceHistory", b =>
                {
                    ...
                    b.HasOne("LKvitai.MES.Modules.Warehouse.Domain.Entities.PriceGroup", null)
                        .WithMany()
                        .HasForeignKey("PriceGroupId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("LKvitai.MES.Modules.Warehouse.Domain.Entities.Location", b =>
                {
                    ...
                    b.HasOne("LKvitai.MES.Modules.Warehouse.Domain.Aggregates.WarehouseLayout", null)
                        .WithMany()
            ...
            modelBuilder.Entity("LKvitai.MES.Modules.Warehouse.Domain.Entities.PriceGroup", b =>
                {
                    ...
                    b.Navigation("ItemPriceOverrides");
                });
