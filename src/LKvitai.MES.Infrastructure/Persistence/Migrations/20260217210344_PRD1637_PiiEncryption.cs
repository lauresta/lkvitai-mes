...
{
    /// <inheritdoc />
    public partial class PRD1637_PiiEncryption : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterColumn<string>(
                name: "default_shipping_address_zip_code",
                schema: "public",
                table: "customers",
                type: "text",
                nullable: true,
            ...
            migrationBuilder.AlterColumn<string>(
                name: "default_shipping_address_street",
                schema: "public",
                table: "customers",
                type: "text",
                nullable: true,
            ...
            migrationBuilder.AlterColumn<string>(
                name: "default_shipping_address_state",
                schema: "public",
                table: "customers",
                type: "text",
                nullable: true,
            ...
            migrationBuilder.AlterColumn<string>(
                name: "default_shipping_address_country",
                schema: "public",
                table: "customers",
                type: "text",
                nullable: true,
            ...
            migrationBuilder.AlterColumn<string>(
                name: "default_shipping_address_city",
                schema: "public",
                table: "customers",
                type: "text",
                nullable: true,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_pii_encryption_keys", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_pii_encryption_keys_Active",
                schema: "public",
                table: "pii_encryption_keys",
                column: "Active");

            migrationBuilder.CreateIndex(
                name: "IX_pii_encryption_keys_KeyId",
                schema: "public",
                table: "pii_encryption_keys",
                column: "KeyId",
                unique: true);
